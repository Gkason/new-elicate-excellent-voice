...
export class ReplyRequest extends EventEmitter {
    ...
    public async onError(error: string) {
        ...
        this.content += `\n\nI'm sorry, I'm having trouble connecting ELICATE TECHNOLOGIES (${error || 'no response from the API'}). Please make sure you've entered your ELICATE API key correctly and try again.`;
